...
const DiagnosisForm = ({ onDiagnosis, sessionId }) => {
  ...
  return (
   ...
   <div className="bg-transparent shadow rounded-lg grid grid-cols-2 h-[40rem]">
      {/* left */}
      <div className="">
        <div>
          <p className="font-[Times] text-white text-2xl font-bold text-center ">
            Welcome to the Microsoft Hackathon - Innovating with Azure AI &
            Microsoft Fabric
          </p>

          <h1 className="font-extrabold font-[Times] mt-1 text-center bg-gradient-to-r from-[#0355ba] via-[#909004] to-black w-max text-transparent bg-clip-text text-[25px]">
        ...
        <div className="flex gap-5 items-center justify-center mt-10">
          <div>
            <img className="w-50 h-50 " src={azure} alt="" />
          </div>
          <h1 className="font-bold text-4xl bg-gradient-to-r from-blue-500 to-green-500 text-transparent bg-clip-text">
            &
          </h1>
          <div>
            <img className="w-50 h-50" src={fabric} alt="" />
          </div>
        </div>
      </div>
      {/* right */}
        <div className="border-[#000300] border-2 rounded-xl" >
        ...
        <div className="relative " >
          ...
          <div className={`absolute inset-0 ${showD ? "" : "bg-black/80 rounded-xl"}`} />
          <img src={imageURL || BGlogo} className="h-[300px] w-full object-cover object-center rounded-xl" />
        </div>
        ...
        >
            ...
            <span className="text-2xl text-[#000300] font-bold">Upload image</span>
            <label
          ...
          <div className="flex items-center justify-between flex-col ">
            <label className="block text-[#000300] text-2xl font-bold bg-gradient-to-r from-gray-700 to-green-900  w-max bg-clip-text">
            ...
            <textarea
              ...
              className="m-1 block w-[80%] p-2 rounded-md bg-blue-200 shadow-sm outline-0 focus:ring-2 focus:ring-blue-500 sm:text-sm"
            />
          </div>
          ...
          <div className="flex items-center justify-center">
            <button
              type="submit"
              className="w-[180px] h-[30px] py-1.5 text-[15px] font-[Times] font-bold rounded-[7px] shadow-[0px_0px_10px_black] text-white bg-gradient-to-r from-blue-200 to-black hover:transform-[scale(1.1)] transition-[5s]
                     focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer border-1 my-2"
            >
